...
@section('content')
        ...
        <div class="col-lg-12 col-md-12">
            <div class="jumbotron jumbotron-fluid">
                <div class="container container-fluid">
                    <h2 class="text-center">Akademi Komunitas Negeri Gianyar</h2>
                    <p class="text-center">Menjadi Institusi Yang Unggul Dalam Pendidikan Vokasi Yang Inovatif Dan Adaptif Terhadap Perkembangan Ilmu Pengetahuan Dan Teknologi Terapan Berbasis Potensi Dan Budaya Lokal Menuju Standarisasi Nasional Tri Dharma Pendidikan Tinggi Pada Tahun 2030.</p>
                </div>
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-md-3 ">
                <div class="grey-box-icon shadow-effect">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="newsBox shadow-effect">
                        <div class="thumbnail">
